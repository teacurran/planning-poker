 ...
 * API and provides type-safe access to JWT claims.
 * </p>
 * <p>
 ...
 *   <li>Roles - from JWT custom claim (e.g., "USER",
 *       "PRO_USER", "ORG_MEMBER")</li>
 *   <li>Subscription Tier - from JWT custom claim (e.g., "FREE",
 *       "PRO", "ENTERPRISE")</li>
 ...
 * <ul>
 *   <li>All methods assume the request has been authenticated by
 *       {@link JwtAuthenticationFilter}</li>
 *   <li>Calling these methods on public endpoints will return null
 *       or throw exceptions</li>
 *   <li>Always use {@code @RolesAllowed} annotations on endpoints
 *       before calling these methods</li>
 * </ul>
 * </p>
 *
...
public class SecurityContextImpl {
     ...
     * @throws IllegalStateException if JWT claims are not available
     *         in security context
     */
     ...
     * <p>
     * This is the tier from the JWT's custom tier claim
     * (e.g., "FREE", "PRO", "ENTERPRISE").
     * </p>
     *
     * @return The current user's subscription tier, or null
    ...
    /**
     * Gets the full JWT claims object for the current authenticated
     * user.
     * <p>
     * This provides access to all JWT claims including userId, email,
     * roles, and tier. Use this method when you need access to multiple
     * claim values or want to use the convenience methods on
     * {@link JwtClaims} (e.g., {@code hasRole()}).
     * </p>
     *
     * @return The current user's JWT claims, or null
     *         if not authenticated
     * @throws IllegalStateException if security identity is available
     *         but claims are missing
     */
    public JwtClaims getCurrentClaims() {
        ...
        if (claimsObj == null) {
            throw new IllegalStateException(
                ...
                + "This endpoint may not have been properly "
                + "authenticated.");
        }

        if (!(claimsObj instanceof JwtClaims)) {
            throw new IllegalStateException(
                "Invalid JWT claims type in security context: "
                + claimsObj.getClass());
        }
     ...
     * <p>
     * This is a convenience method that delegates to the Quarkus
     * SecurityIdentity.
     * </p>
     *
     ...
     * <p>
     * This is a common authorization check for endpoints like
     * GET/PUT /users/{userId} where users should only access their
     * own data.
     * </p>
     *
